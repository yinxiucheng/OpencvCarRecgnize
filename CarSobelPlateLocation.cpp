...
int CarSobelPlateLocation::verifySizes(RotatedRect rotated_rect) {
    //容错率
    float error = 0.75f;
...
* 矫正
*/
void CarSobelPlateLocation::tortuosity(Mat src, vector<RotatedRect> &rects, vector<Mat> &dst_plates) {
    //循环要处理的矩形
...
void CarSobelPlateLocation::safeRect(Mat src, RotatedRect rect, Rect2f &dst_rect) {
...
void CarSobelPlateLocation::rotation(Mat src, Mat &dst, Size rect_size,
